...
import 'admin_order_detail_model.dart';
export 'admin_order_detail_model.dart';
...
class AdminOrderDetailWidget extends StatefulWidget {
  ...
  @override
  State<AdminOrderDetailWidget> createState() => _AdminOrderDetailWidgetState();
}

class _AdminOrderDetailWidgetState extends State<AdminOrderDetailWidget> {
  late AdminOrderDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminOrderDetailModel());

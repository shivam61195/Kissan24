...
import 'admin_create_product_model.dart';
export 'admin_create_product_model.dart';
                                                  ...
                                                  child: ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.asset(
                                                      'assets/images/360_F_164165971_ELxPPwdwHYEhg4vZ3F4Ej7OmZVzqq4Ov.jpg',
                                                      width: 400.0,
                                                      height: 300.0,
                                                      fit: BoxFit.contain,
                                                    ),
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowChoiceChips(
                                          options: const [
                                            ChipData('Seeds'),
                                            ChipData('Herbicides'),
                                            ChipData('Insecticide'),
                                            ChipData('Fungicide'),
                                            ChipData('Growth Promoter')
                                          ],
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await ProductsRecord.collection.doc().set({
                            ...createProductsRecordData(
                              ...
                              salePrice: double.tryParse(
                                  _model.salesPriceController.text),
                          ...
                          await Future.wait([
                            Future(() async {
                              setState(() {
                                _model.productNameController?.clear();
                                _model.descriptionController?.clear();
                                _model.salesPriceController?.clear();
                              });
                            }),
                            Future(() async {
                              setState(() {
